...
import com.electrofire.playpkm.ui.ViewModels.games.verificarRespuestaMovePower
...
import com.electrofire.playpkm.ui.ViewModels.games.MovePowerViewModel

@Composable
fun MovePowerGame(
    navController: NavController,
    viewModel: MovePowerViewModel = hiltViewModel(),
            ...
            is UIState.Success -> {
                ...
                Column(
                    ...
                    if (!gameStateViewModel.respondido) {
                        ...
                        val esCorrecto = verificarRespuestaMovePower(respuesta, movimientoActual)
                        GameResultDialog(
                            isWin = esCorrecto,
                            onHomeClick = {
                                navController.navigate("home") {
                                    popUpTo(Screen.MovePowerGame.route) { inclusive = true }
                                }
                            },
                            content = {
                        ...
                        LaunchedEffect(gameStateViewModel.respondido) {
                            if (verificarRespuestaMovePower(
                                    respuesta,
                                    movimientoActual
                                )
                            ) {
