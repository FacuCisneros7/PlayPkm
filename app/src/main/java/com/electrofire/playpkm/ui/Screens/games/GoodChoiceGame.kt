...
import com.electrofire.playpkm.ui.ViewModels.games.GoodChoiceViewModel

@Composable
fun GoodChoiceGame(
    navController: NavController,
    viewModel: GoodChoiceViewModel = hiltViewModel(),
    ...
    LaunchedEffect(state) {
        if (state is UIState.Success && (state as UIState.Success).data.isGameOver) {
            statsViewModel.registrarMaxScoreNinthGame((state as UIState.Success).data.puntaje)
        }
    }
                ...
                Column(
                    ...
                    if (!isGameOver) {
                        ...
                        GameResultDialog(
                            isGameOver = true,
                            puntaje = puntaje,
                            maxScore = usuario.maxPoints,
                            onHomeClick = {
                                navController.navigate("home") {
                                    popUpTo(Screen.GoodChoiceGame.route) { inclusive = true }
                                }
                            },
                            onRetryClick = {
