...
import com.electrofire.playpkm.ui.ViewModels.games.verificarRespuestaBlurredCard
...
import com.electrofire.playpkm.ui.ViewModels.games.BlurredCardViewModel

@Composable
fun BlurredCardGame(
    navController: NavController,
    viewModel: BlurredCardViewModel = hiltViewModel(),
            ...
            is UIState.Success -> {
                ...
                Column(
                    ...
                    if (!gameStateViewModel.respondido) {
                        ...
                        val esCorrecto = verificarRespuestaBlurredCard(cartaActual, respuesta)
                        GameResultDialog(
                            isWin = esCorrecto,
                            onHomeClick = {
                                navController.navigate("home") {
                                    popUpTo(Screen.BlurredCardGame.route) { inclusive = true }
                                }
                            },
                            content = {
                        ...
                        LaunchedEffect(gameStateViewModel.respondido) {
                            if (verificarRespuestaBlurredCard(
                                    cartaActual,
                                    respuesta
                                )
                            ) {
