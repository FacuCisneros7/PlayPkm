...
import com.electrofire.playpkm.ui.ViewModels.games.SilhouetteViewModel
import com.electrofire.playpkm.ui.ViewModels.games.verificarRespuestaSilhouette

@Composable
fun SilhouetteGame(
    navController: NavController,
    viewModel: SilhouetteViewModel = hiltViewModel(),
            ...
            is UIState.Success -> {
                ...
                Column(
                    ...
                    if (!gameStateViewModel.respondido) {
                        ...
                        val esCorrecto = verificarRespuestaSilhouette(pokemonActual, respuesta)
                        GameResultDialog(
                            isWin = esCorrecto,
                            onHomeClick = {
                                navController.navigate("home") {
                                    popUpTo(Screen.SilhouetteGame.route) { inclusive = true }
                                }
                            },
                            content = {
                        ...
                        LaunchedEffect(gameStateViewModel.respondido) {
                            if (verificarRespuestaSilhouette(pokemonActual, respuesta)) {
