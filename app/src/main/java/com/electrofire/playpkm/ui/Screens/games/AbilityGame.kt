...
import com.electrofire.playpkm.ui.ViewModels.games.AbilityViewModel
import com.electrofire.playpkm.ui.ViewModels.games.verificarRespuestaAbility
            ...
            is UIState.Success -> {
                ...
                Column(
                    ...
                    if (!gameStateViewModel.respondido) {
                        ...
                        val esCorrecto = verificarRespuestaAbility(pokemonActual, respuesta)
                        GameResultDialog(
                            isWin = esCorrecto,
                            onHomeClick = {
                                navController.navigate("home") {
                                    popUpTo(Screen.AbilityGame.route) { inclusive = true }
                                }
                            },
                            content = {
